...
export const PageContent = () => {
  return (
    <>
      ...
      <Heading size="md">Privacy Policy for kootenaymediation.ca </Heading>
      <ul>
        <li>Type of website: Informational</li>
        <li> Effective date: 1st day of Sepetember, 2023 </li>
      </ul>
      <p>
        kootenaymediation.ca (the "Site") is owned and operated by Judah Harrison Barrister & Solicitor. Judah Harrison is the data controller and can
        be contacted at: jh@jhlo.ca
      </p>
      ...
      <Heading size="md">GDPR</Heading>
      <p>
        For users in the European Union, we adhere to the Regulation (EU) 2016/679 of the European Parliament and of the Council of 27 April 2016,
      ...
      <p>
        ...
        <a className="privacy" href="mailto:jh@jhlo.ca?subject=Remove Consent">
      ...
      <p>
        We rely on the following legal basis to collect and process the personal data of users in the EU: Users have provided their consent to the
        processing of their data for one or more specific purposes.
      </p>

      <Heading size="md">Personal Data We Collect</Heading>
      <p>
        We only collect data that helps us achieve the purpose set out in this PrivacyPolicy. We will not collect any additional data beyond the data
      ...
      <Heading size="md">How We Use Personal Data</Heading>
      <p>
      ...
      <Heading size="md">Who We Share Personal Data With</Heading>
      ...
      <Heading size="md">How Long We Store Personal Data</Heading>
      <p>
        User data will be stored until the purpose the data was collected for has been achieved. You will be notified if your data is kept for longer
        than this period.
      </p>
      ...
      <Heading size="md">Your Rights as a User</Heading>
      ...
      <p>
        We do not knowingly collect or use personal data from children under 16 years of age. If we learn that we have collected personal data from a
        child under 16 years of age, the personal data will be deleted as soon as possible. If a child under 16 years of age has provided us with
        personal data their parent or guardian may contact our privacy officer.
      </p>

      <Heading size="md">How to Access, Modify, Delete, or Challenge the Data Collected</Heading>
      <p>
        If you would like to know if we have collected your personal data, how we have used your personal data, if we have disclosed your personal
        data and to who we disclosed your personal data, if you would like your data to be deleted or modified in any way, or if you would like to
        exercise any of your other rights under the GDPR, please contact our privacy officer here:{" "}
        <a className="privacy" href="mailto:privacy@kootenaymediation.ca?subject=Access or Challenge the Data Collected">
          privacy@kootenaymediation.ca
        </a>{" "}
      </p>

      <Heading size="md">Do Not Track Notice</Heading>
      <p>
      ...
      <p>
        ...
        You can choose to be notified each time a cookie is transmitted. You can also choose to disable cookies entirely in your internet browser, but
      ...
      <ol>
        <li>
          ...
          <ol type="a">
            <li>
              Analytical cookies allow us to improve the design and functionality of our Site by collecting data on how you access our Site, for
      ...
      <p>
        This Privacy Policy may be amended from time to time in order to maintain compliance with the law and to reflect any changes to our data
        collection process. When we amend this Privacy Policy we will update the "Effective Date" at the top of this Privacy Policy. We recommend that
        our users periodically review our Privacy Policy to ensure that they are notified of any updates. If necessary, we may notify users by email
        of changes to this Privacy Policy.
      </p>
      ...
      <p>
        If you feel we have not addressed your concern in a satisfactory manner you may contact a supervisory authority. You also have the right to
        directly make a complaint to a supervisory authority. You can lodge a complaint with a supervisory authority by contacting us directly
      </p>

      <Heading size="md">Contact Information</Heading>
      <p>
        If you have any questions, concerns or complaints, you can contact us, Kootenay Mediation at:&nbsp;
        <a className="privacy" href="mailto:jh@jhlo.ca?subject=Questions, Concerns or Complaints">
          privacy@kootenaymediation.ca
        </a>{" "}
      </p>
    </>
